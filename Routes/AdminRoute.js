...
admin_route.get('/', noCache, auth.isLogin1, adminControl.Loadadminlogin); // login page loading whether admin loged in or not
...
admin_route.get('/Delete-Category/:id', auth.isLogin, CategoryControl.deleteCategory) // for deleting the categroy
